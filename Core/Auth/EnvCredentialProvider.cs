...
namespace FeCloud.SDK.Core.Auth
{
    ...
    {
        private const string AkEnvName = "FECLOUD_SDK_AK";
        private const string SkEnvName = "FECLOUD_SDK_SK";
        private const string ProjectIdEnvName = "FECLOUD_SDK_PROJECT_ID";
        private const string DomainIdEnvName = "FECLOUD_SDK_DOMAIN_ID";
        private const string SecurityTokenEnvName = "FECLOUD_SDK_SECURITY_TOKEN";
